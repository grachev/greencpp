...
inline std::ostream& operator <<(std::ostream& out, const TCont& cont);
inline std::ostream& operator <<(std::ostream& out, const TContRep& cont);
...
class TCont {
    ...
    #error todo
        ...
        inline TContIOStatus ReadExactI(SOCKET fd, void* buf, size_t len) {
        	...
        	return TContIOStatus::Success(len);
        }
